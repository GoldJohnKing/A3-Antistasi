...
_targets = nearestObjects [getposATL _container, ["Man"], 250]; // Edited: Increase loot range, default = 10
_weaponHolders = nearestObjects [getposATL _container, ["WeaponHolder","WeaponHolderSimulated"], 250]; // Edited: Increase loot range, default = 10
